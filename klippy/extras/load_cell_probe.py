    ...
    def _average_force(self, gcmd, precise):
        ...
        while True:
          ...
          for i in range(0, n_average) :
            self._adc_wait_conversion_ready()
            force = force + self._last_uncompensated_force
            min_force = min(self._last_uncompensated_force, min_force)
            max_force = max(self._last_uncompensated_force, max_force)
