...
ADS1100_MAXVALUE_BY_RATE_TABLE={ 8:65536, 16:32768, 32:16394, 128:8192 }
...
class MCU_ADS1100:
    ...
    def __init__(self, main):
        ...
        self.rate = main.rate
        self.norm = float(ADS1100_MAXVALUE_BY_RATE_TABLE[self.rate])
        self.gain = main.gain
        self._last_value = 0.
        self._last_time = 0
    ...
    def _sample_timer(self, eventtime):
        ...
        self._last_value = struct.unpack('>h', response[0:2])[0] / self.norm
