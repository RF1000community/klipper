...
[Load-cell probe guide (RF1000 community version)](RF1000LoadCellProbe.md) and
[command reference](G-Codes.md#rf1000_load_cell_probe) for further
information. Some of the parameters are determined in a semi-automatic
[calibration procedure](RF1000LoadCellProbe.md#setup-for-new-printer-models).
