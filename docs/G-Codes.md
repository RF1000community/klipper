...
### [rf1000_load_cell_probe]

The following commands are available when a
[rf1000_load_cell_probe config section](Config_Reference.md#rf1000_load_cell_probe) is enabled
(also see the [Load-cell probe guide (RF1000 community version)](RF1000LoadCellProbe.md)):
...
the [calibration procedure](RF1000LoadCellProbe.md#setup-for-new-printer-models). The
